...
- 🔭 현재 **우아한 테크 캠프**에서 학습 중
- 🌱 **JAVA, SPRING, JPA, OOP, DDD**에 대해 깊이 있게 공부 중
- 👯 **코드 리뷰** 문화에 관심이 많음
- 💬 **JAVA**에 대해 물어보세요
- ⚡ 재미있는 사실: 세상은 아름답습니다!
...
<details>
<summary>기술 스택 상세 설명</summary>

- **Java**: OOP 원칙 적용, 멀티스레딩/제네릭스/람다 활용
- **Spring**: Spring Core/MVC/Boot 사용, DI/AOP 적용
- **JPA**: 기본 CRUD 구현, 연관 관계 매핑 이해
- **MySQL**: 복잡한 쿼리 작성/최적화, 인덱싱 경험
- **MongoDB**: 기본 CRUD 및 간단한 집계 쿼리 작성
- **Redis**: 캐싱/세션 저장소 활용
- **Git/GitHub**: 브랜치 전략 수립, CI/CD 파이프라인 구축
- **OOP**: SOLID 원칙 이해/적용, 디자인 패턴 활용
- **DDD**: 도메인 모델링, 부분적 프로젝트 적용
